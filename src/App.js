...
import FallSemester from "./FallSemester";
import SpringSemester from "./SpringSemester";

function App() {
  return (
    <Routes>
      <Route path="/" element={<Home />} />
      <Route path="/fall" element={<FallSemester />} />
      <Route path="/spring" element={<SpringSemester />} />
    </Routes>
  );
}
...
//         </div>
//       </div>
//       <div style={{ height: "100vh", background: "rgb(206, 201, 187)" }}>
...
//           }}
//         >
//           <Link to="/fall">Fall Semester</Link>
//           <Link to="/spring">Spring Semester</Link>
//         </div>
//       </div>
